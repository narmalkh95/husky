...
function App() {
  return (
    <div className="App">
      <BrowserRouter>
        <Switch>
          <PublicRoute path={paths.Registration}>
            <Registration />
          </PublicRoute>
          {/* <PublicRoute
            path={paths.Verify}
          ...
          <PublicRoute path={paths.OldVerification}>
            <Verification />
          </PublicRoute>
          <PublicRoute path={paths.Email}>
            <Email />
          </PublicRoute>
          <PublicRoute path={paths.ResetPassword}>
            <ResetPassword />
          </PublicRoute>
          {/* <PublicRoute
          ...
          <PublicRoute path={paths.EmailPass}>
            <ResetPassword />
          </PublicRoute>
          <PublicRoute path={paths.Login} exact={false}>
            <Login />
          </PublicRoute>
          {/* <PublicRoute
            path={paths.Email}
          ...
          <PrivateRoute path={paths.Upgrade}>
            <Upgrade />
          </PrivateRoute>
          <PrivateRoute path={paths.Desktop}>
            <Desktop />
          </PrivateRoute>
          <PrivateRoute path={paths.ContactUs}>
            <ContactUs />
          </PrivateRoute>
          <PrivateRoute path={paths.Payment}>
            <Stripe />
          </PrivateRoute>
          <PrivateRoute path={paths.Importdata} exact>
            <ImportData />
          </PrivateRoute>
          {/* --------------------------new private routes-------------------------------------------------------------------------------- */}
          {/* <PrivateRoute

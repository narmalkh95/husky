...
function UpgradeCard(props) {
  ...
  return (
    <div className={`upgrade_item1_container ${shadow}`}>
      <div className="upgrade_item1_header">{props.header}</div>
      <div className="upgrade_item1_text">{props.subHeader}</div>
      ...
      <div className="upgrade_item1_button_container">
        <button
          className="upgrade_item1_button"
          onClick={props.handleUpgradeButtonClick}
        >
          {props.button_text}
        </button>
      </div>

    ...
    fetch(
      ...
      .then((response) => {
        if (response.status === 403) {
          Toaster.notify(
            'There is not any data to download.',
            ToasterType.failure
          );
    ...
    <div className="right_bar_container">
      ...
      <div className="notes_list">
        {!Object.keys(notes).length ? (
          <div className="not_available"> Not available yet </div>
        ) : (
      ...
      <div className="btn_container">
        <div className="single_annotation_btn_container">
          <div className="single_annotation_btn_border">
            <button
              className="single_annotation_btn"
              onClick={detectOnSingleImage}
            >

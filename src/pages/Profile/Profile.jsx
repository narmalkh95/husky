      ...
      .then(() => {
        fetch(`${apiUrl}get-folders`, {
          ...
          .then((data) => {
            if (
              data.status === 'fail' &&
              data.message === 'No folder created.'
            ) {
  ...
  function handleSubmit(event) {
    ...
    if (name !== '' && surname !== '' && email !== '') {
      ...
      if (old_password !== '' || confirmed_pass !== '' || password !== '') {
        ...
        password === '' || password !== confirmed_pass
          ? setPasswordError(true)
          : setPasswordError(false);
        confirmed_pass === '' || password !== confirmed_pass
          ...
          <div className={`profile_container ${showMenu}`}>
            ...
            <div className="profile__wrapper">
              ...
              {!strongRegex.test(password) && password !== '' && (
                <div className="error__message" style={{ width: '440px' }}>

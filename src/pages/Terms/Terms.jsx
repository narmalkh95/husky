  ...
  return (
    <>
      ...
      <div className="terms_of_use_container">
        <div className="terms_of_use_subcontainer">
          <h2>
            <span className="sub_headers">TERMS OF USE</span>
          </h2>
          <p>
            <span className="sub_headers">Last updated October 04, 2021</span>
          </p>
          <p className="single_gap" />
          <h3>
          ...
          <p>
            <span>
              ...
              and manot, Inc. ("Company," “we," “us," or “our”), concerning your
              ...
              Delaware, United States and have our registered office at 651 N
              Broad St, Suite 206 Middletown, DE, 19709, Middletown, DE 19709.
          ...
          <p>
            <span>
              ...
              jurisdiction in which you r eside; (5) you will not access the
          ...
          <p>
            <span>
              19. Except as may be the result of the standard search engine or
          ...
          <p>
            <span>24. Sell or otherwise transfer your profile.</span>
          </p>
          <p className="single_gap" />
          <p className="single_gap" />
          <h3>
          ...
          <p>
            <span>
              ...
              Site is hosted in__________. If you access the Site from any other
              region of the world with laws or other requirements governing
              personal data collection, use, or disclosure that differ from
              applicable laws in __________, then through your continued use of
              the Site, you are transferring your data to __________, and you
              agree to have your data transferred to and processed in
              __________.
            </span>
          </p>
          <p className="single_gap" />
          ...
          <p>
            <span>
              ...
              Delaware, and the Parties hereby consent to and waive all defences
          ...
          <p>
            <span>
              ...
              efforts to notify you of any such claim, action, or a proceeding
          ...
          <p>
            <span>651 N Broad St, Suite 206 Middletown, DE, 19709</span>
          </p>
          <p>

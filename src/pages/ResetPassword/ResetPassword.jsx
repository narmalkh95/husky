...
function ResetPassword(props) {
  ...
  function validatePass(password, errorFunction) {
    return (
      password === '',
      !validatePassword(new_pass) ? errorFunction(true) : errorFunction(false)
    );
  }
        ...
        <div className="registration__wrapper">
          ...
          <div className="signup__right__part">
            <div className="signin__fields__wrapper">
              <div className="signup__fields__header">forgot password?</div>
              {!secondView ? (
                <>
                  <div className="reset__fields__wrapper">
                    Enter the email assiciated with your account, and we will
                  ...
                  {emailError && (
                    <div className="error__message message__wrapper">
                      {' '}
                      {emailError}{' '}
                    </div>
                  )}
                  {userMessage && (
                    <div className="success_message message__wrapper">
                      {userMessage}
                    </div>
                  )}
                </>
                    ...
                    InputProps={{
                      endAdornment: (
                        <InputAdornment position="end" className="pass__eye">
                          <div onClick={() => setShowNew_pass(!showNew_pass)}>
            ...
            <Link className="redirect__to__reset__password" to={paths.Login}>
              login
            </Link>

        ...
        <Card className="payment-card-container">
          ...
          >
            ...
            <MaskedInput
              ...
              {...register('cardName', {
                required: 'The card number is not valid',
              })}
            />
            {errors.cardName && (
              <div className="error_message">{errors.cardName.message}</div>
            )}
            ...
            <div className="payment-input-group">
              <div>
                <label className="card-number-min-lable">
                  Expiration date
                  <Typography color="secondary">(MM/YY)</Typography>
                </label>
                ...
                <MaskedInput
                  ...
                  {...register('date', {
                    required: 'The expiration date is not valid',
                  })}
                />

                {errors.date && (
                  <div className="error_message">{errors.date.message}</div>
                )}
              </div>
              ...
              <div>
                <label className="card-number-min-lable">
                  CVV
                  <Typography color="secondary">(4 digits)</Typography>
                </label>
                <MaskedInput
                  mask={[/[0-9]/, /\d/, /\d/, /\d/]}
                  required

...
function Registration(props) {
  ...
  const [hasAcceptCheckboxErrorBorder, setHasAcceptCheckboxErrorBorder] =
    useState('');
        ...
        <div className="registration__wrapper">
          ...
          <div className="signup__right__part">
            <div className="signup__fields__wrapper">
              <div className="signup__fields__header">sign up</div>
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end" className="pass__eye">
                        <div
                          onClick={() =>
                            setShowConfirmed_pass(!showConfirmed_pass)
                          }
                        >
                          {showConfirmed_pass ? (
                            <Visibility />
              ...
              <div
                className={`terms__policy__checkbox__wrapper ${hasAcceptCheckboxErrorBorder}`}
              >
                <input
                  type="checkbox"
                  ...
                  onClick={() => {
                    !accept
                      ? setHasAcceptCheckboxErrorBorder('')
                      : setHasAcceptCheckboxErrorBorder('with__err__border');
                    setAccept(!accept);
                  }}
                />
                {'  Accept our  '}
                ...
                {'  and  '}
                <Link to={paths.Policy} target="_blank">
                  Privacy Policy
                </Link>
              </div>
              ...
              <Link className="redirect__to__login" to={paths.Login}>
                login
              </Link>
            </div>
          </div>

      ...
      <div className="registration__wrapper">
        ...
        <div className="signup__right__part">
          <div className="signin__fields__wrapper">
            <div className="signup__fields__header">verify your email</div>
            <div className="mail__content__wrapper">
              <div className="mail__content__subwrapper">
                <div>We have sent an email</div>
                <div>
                  You need to verify your email to continue, if you have not
                  recieved verification email, please check your “Spam” or “Bulk
                  Email” folder.
                </div>
              </div>
            </div>

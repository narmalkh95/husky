    ...
    <>
      ...
      <div className="terms_of_use_container">
        <div className="terms_of_use_subcontainer">
          <h2>
            <span className="sub_headers">Privacy Policy</span>
          </h2>
          <p className="single_gap" />
          <p>
            <span>Last updated: September 28, 2021</span>
          </p>
          <p className="single_gap" />
          <p>
            <span>
          ...
          <p>
            <span>
              ...
              Company", "We", "Us" or "Our" in this Agreement) refers to manot,
              Inc., 651 N Broad St, Suite 206 Middletown, DE, 19709 USA.
            </span>
          </p>
          <p className="single_gap" />
          <p>
          ...
          <p>
            <span>
              <strong>{'• Website '}</strong>refers to manot, accessible from
              <a href="https://manot.tech/" target="blank">
                {' https://manot.tech/'}
              </a>
            </span>
          </p>
          ...
          <p>
            <span>
              ...
              Service may use local stored objects (or Flash Cookies) to collect
              and store information about Your preferences or Your activity on
              our Service. Flash Cookies are not managed by the same browser
              ...
              Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_
            </span>
          </p>
          <p className="single_gap" />
          <p>
          ...
          <p>
            <span>
              <strong>{'• Necessary / '}</strong> Essential Cookies
            </span>
          </p>
          <p className="single_gap" />
          <p>
          ...
          <p>
            <span>
              ...
              information and Your country c requires consent from a parent, We
          ...
          <p className="single_gap" />
          <p>
            <span>• By email: info@manot.tech</span>
          </p>
          <p className="single_gap" />
          <p>
            <span>

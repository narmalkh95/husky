...
function Registration_old(props) {
  ...
  function validate() {
    ...
    if (confirmed_pass === '') {
      setConfirmed_passError('Please enter password');
    }
  }
          ...
          <div className="form_wrapper">
            <form className="form" onSubmit={handleSubmit}>
              ...
              {!surname && surnameError && (
                <div className="error_message">{surnameError}</div>
              )}
              ...
              <div className="pass_wrapper">
                <input
                  ...
                  onChange={(e) => {
                    setConfirmed_pass(e.target.value);
                  }}
              ...
              {!confirmed_pass && (
                <div className="error_message">{confirmed_passError}</div>
              )}
              {!isMatched && (
                <div className="error_message">Passwords don't match</div>
              )}

...
function NewLogin(props) {
  ...
  useEffect(() => {
    params.id && setIsFromEmail(!params.id.includes('account'));
    ...
    fetch(`${apiUrl}login`, {
      ...
      .then((data) => {
        if (
          ...
          setError(
            'Your account is not activated yet. Please check the email.'
          );
        } else {
        ...
        <div className="registration__wrapper">
          ...
          <div className="signup__right__part">
            <div className="signin__fields__wrapper">
              ...
              <div className="signup__fields__header">login</div>
            ...
            <Link
              className="redirect__to__reset__password"
              to={paths.EmailPass}
            >
              forgot password?
            </Link>

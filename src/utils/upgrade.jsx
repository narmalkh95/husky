const upgradeData = {
  Free: {
    ...
    body: [
      'up to 500 images',
      'single user',
      'up to 1024x1024 resolution size',
      'detection on single image',
      'manual rotated and bounding box annotation',
  ...
  Business: {
    ...
    body: [
      ...
      'up to 1000 images',
      'up to 1024x1024 resolution size',
      'full data automated annotation',
      'video annotation (coming soon)',
      '10-15% manual correction',
    ],
  ...
  Enterprise: {
    ...
    body: [
      ...
      'unlimited images',
      'multiple users',
      'up to 4096x4096 resolution size',
      '24/7 support by our Data Experts',
